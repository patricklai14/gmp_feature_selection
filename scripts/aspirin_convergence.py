...
def main():
    ...
    top_dir = "/storage/home/hcoda1/7/plai30"
    ...
    for i in range(num_eval_trials):
        ...
        curr_test_config["name"] = "convergence_{}".format(i + 1)
    ...
    save_model_dir = curr_dir / "convergence_model_checkpoints"
    num_training_iters = 5

    for i in range(num_training_iters):
        print("Evaluating models for training iteration {}".format(i + 1))
        workspace = curr_dir / "workspace_convergence_{}".format(i + 1)
