...
class genetic_algorithm(gmp_fs.gmp_feature_selector):
    ...
    def generate_initial_population(self, population_size, target_num_groups, num_sigmas):
        ...
        #sigmas = [0.25, 1.0, 2.0]
        max_sigma = 2.5
        sigmas = np.random.uniform(0.0, max_sigma, size=num_sigmas)
        ...
        for i in range(population_size):
            ...
            curr_seq = gene_sequence(curr_groups, sigmas)
    ...
    def crossover(self, parents, target_num_groups):
        ...
        return (gene_sequence(groups_1, sigmas_1), gene_sequence(groups_2, sigmas_2))
